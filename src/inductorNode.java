 ...
 */
public class inductorNode implements Node
{
    /**
     ...
     */
    public inductorNode(Color aColor)
    {
        height = DEFAULT_SIZE;
        width = DEFAULT_SIZE;
        x = 0;
    ...
    public void draw(Graphics2D g2)
    {
        ...
        try {
            image = ImageIO.read(new File("src/inductor.png"));
        } catch (IOException ex) {
            System.out.println("Cant load image");
        }

        g2.drawImage(image, (int)x,(int)y,70,70,null);
      //  String indLabel = "L"+this.getCount();
        g2.drawString("L"+this.labelid, (int)x+28, (int)y+10);
     //   GraphFrame.addIndLabels(indLabel, this.getCount());
    }
    ...
    public int getCount(){
        return indLabelCounter;
    }
    public void  incCounter(int count){
        indLabelCounter = count;
    }

    public int typeComp(){return 3;}
