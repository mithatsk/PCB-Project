...
public abstract class Graph implements Serializable
{
   ...
   public void draw(Graphics2D g2)
   {
     ...
     for (Node n : nodes)
      ...
      /*if(theState){
         theNode.rotationDraw(g2);
         //removeNode(theNode);
         //add(theNode,mousePointer);
         //theState= false;
      }*/
   }
   ...
   public static void rotationState(boolean state, Node node ,Point2D mousePoint){

      theNode = node;
      mousePointer = mousePoint;
      System.out.println("yo mama" + state);
   }

   public static void makeRotation(boolean state){
   ...
   private static boolean theState;
   public static Node theNode;
   private static Point2D mousePointer;
